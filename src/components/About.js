            ...
            <div className="w-full h-full absolute top-0" id="aboutUs">
                ...
                >
                    ...
                    <div className="bg-gray-800 p-5 my-5 w-full py-12 ">
                        ...
                        <h1 className="md:w-4/5 lg:w-3/4 xl:w-1/2 mx-10 md:mx-auto text-white text-2xl uppercase lg:text-md font-medium mt-8">A <span className="yellow">Te</span> elvárásaid alapján készül minden</h1>
                        <p className="md:w-4/5 lg:w-3/4 xl:w-1/2 mx-10 pr-2 md:mx-auto text-white text-md md:text-lg lg:text-md mt-5 font-medium text-justify border-r-4 md:pr-4 border-orange-300">
                        ...
                        <h1 className="md:w-4/5 lg:w-3/4 xl:w-1/2 mx-10 md:mx-auto text-white text-2xl uppercase lg:text-md font-medium mt-8"><span className="yellow">Weboldalak</span> melyeket készítünk</h1>
                        <p className="md:w-4/5 lg:w-3/4 xl:w-1/2 mx-10 pl-2 md:mx-auto text-white text-md md:text-lg lg:text-md mt-5 font-medium text-justify border-l-4 md:pl-4 border-orange-300">
