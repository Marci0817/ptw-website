            ...
            <div className="servicesBg w-full h-auto absolute top-0">
                <div className="mt-32 xl:w-2/4 lg:w-3/5 md:w-5/6 p-8 mx-auto">
                    <div className=" mx-auto my-8  ">
                        ...
                        <p className="text-lg text-justify text-white mt-2">Eljárásunk biztosítja, hogy a folyamatok zökkenőmentesek legyenek a végfelhasználó számára, és az első kapcsolatfelvétel során megismerkedjenek a folyamtokkal.
                    ...
                    <div className=" mx-auto my-8  ">
                        ...
                        <p className="text-lg text-justify text-white mt-2">A vállalkozások üzleti sikerének kulcsa, hogy a webes és mobilplatformokon egyedülálló, ügyfeleik igényeit kielégítő alkalmazások álljanak rendelkezésre.
                        ...
                        <p className="text-lg text-justify text-white mt-2">Segítünk neked egy precíz stratégiát létrehozni webalkalmazása fejlesztéséhez, hogy erős webes jelenlétet kiépítésében, hogy kielégítse ügyfeleid igényeit és mérhető sikereket érjen el.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Web app-ok fejlesztése</p>
                        <p className="text-lg text-justify text-white mt-2">Tapasztalatunkat felhasználva egyedi web alkalmazásokat hozzunk létre, amelyek nemcsak vonzóak, hanem hatékonyak, és merhetően nagyobb leadet generálnak.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Webes app-ok tervezése</p>
                        <p className="text-lg text-justify text-white mt-2">Fejlesztőink segítenek kiváló minőségű, felhasználó- és keresőbarát webalkalmazás létrehozásában, amelyek segítségével versenyelőnyre tehetsz szert.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Mobilitás</p>
                        <p className="text-lg text-justify text-white mt-2">Veled együttműködve olyan alkalmazás stratégiákat és megoldásokat dolgozunk ki, amelyek mobilplatformra szabottak és a maximális eléréshez vezetnek.</p>
                        
                        <p className="text-lg text-white mt-4 uppercase yellow">Mobil app-ok fejlesztés</p>
                        <p className="text-lg text-justify text-white mt-2">Többplatformos mobilalkalmazás-fejlesztési megoldásokat kínálunk, amelyek javítják a kapcsolatot a potenciális ügyfelekkel.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Mobil app-ok tervezés
                        </p>
                        <p className="text-lg text-justify text-white mt-2">Fejlesztőink segítenek olyan mobilalkalmazások tervezésében, amelyek páratlan felhasználói élményt, rugalmasságot és üzleti növekedést hoz magával.</p>
                    </div>
                    <hr />
                    <div className=" mx-auto my-8  ">
                        ...
                        <p className="text-lg text-justify text-white mt-2">Büszkék vagyunk arra, hogy a Blockchain technológia előnyeit felhasználva, kívételes megoldásokat tudunk nyújtani az új, modern világ problémáinak megoldásaira.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Smart contract fejlesztés</p>
                        <p className="text-lg text-justify text-white mt-2">A smart contractokat a blockchainen lehet létrehozni, melyek által oylan alkalmazásokat lehet csinálni, melyek a a blockchain előnyeit kihasználva biztonságosak és átláthatóak. Az ilyen alkalmazásokat a Solidity nevű programozási keretrendszerben készítjük el.</p>

                        <p className="text-lg text-white mt-4 uppercase yellow">Decentralizált alkalmazásfejlesztés (DApps)</p>
                        <p className="text-lg text-justify text-white mt-2">A decentralizált alkalmazások vagy DApp-ok a legbiztonságosabb alternatívák a központosított adatközpontokkal szemben.Mivel fő profilunkba tartozik a webes megjelenés kivitelezése a blockckchainen működő alkalmazásokhoz akár webes felületet is tudunk adni.</p>
                    </div>
                </div>
            </div>
        </>
